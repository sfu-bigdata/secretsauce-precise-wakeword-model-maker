...
#TODO load wakeword model name from config
#TODO use wakeword model name as directory name in out directory for output
#TODO make a generate_TTS_data_flow.py file
#TODO update the cli.py file to use the generate_TTS_data_flow.py file
#TODO update README file on the installation and usage of the TTS generator
#TODO add the requirements for apt install into the dockerfile
#TODO test the TTS generator on the docker container
engine_config = load_engine_config(os.getcwd() + '/config/TTS_engine_config.json')
larynx_host = engine_config[0]
TTS_list = engine_config[1]

wakeword_config = load_config(os.getcwd() + '/config/TTS_wakeword_config.json')
